                ...
                <div class="flex items-center">
                    ...
                    <ul class="flex space-x-4">
                        ...
                        <li>
                            ...
                            <span class="text-gray-300 mr-2 text-white" style="margin-left: 30px;">Selamat datang, <?php echo isset($_SESSION["user"]["nama_lengkap"]) ? $_SESSION["user"]["nama_lengkap"] : 'Pengguna'; ?></span>
